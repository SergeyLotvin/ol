...
//        }
        ...
        public T2 get(T1 k) {
                ...
                public Node<T1, T2> getNode(T1 k) {
                    
                Node<T1, T2> x = root;
                
                while (x != null|| (x.getLeft()!=null & x.getRight()!=null)) {
                        int cmp = k.compareTo(x.getKey());
                        if (cmp == 0) {
                                return x;
                        }
                        if (cmp < 0) {
                                x = x.getLeft(); //System.out.println("left and value is "+x.getKey()+" |x.left.value > "+x.getLeft()+"|  |x.right.value > "+x.getRight()+"|");
                        } else {
                                x = x.getRight();//System.out.println("right and value is "+x.getKey()+" |x.left.value > "+x.getLeft()+"|  |x.right.value > "+x.getRight()+"|");
                        }
